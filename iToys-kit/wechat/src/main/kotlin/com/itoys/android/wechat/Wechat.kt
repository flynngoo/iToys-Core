...
object Wechat {
     ...
     *
     */
    fun launch() = api.openWXApp()

    /**
     * 分享
     */
    fun share(mediaMessage: MediaMessage, scene: WechatScene) {
     ...
     * 监听微信回调
     */
    val eventHandlers: MutableSet<WXEventHandler> = mutableSetOf()

    /**
     * 增加回调监听
     */
    fun addEventHandler(eventHandler: WXEventHandler) {
     ...
     * 移除监听
     */
    fun removeEventHandler(eventHandler: WXEventHandler) {
