...
import com.itoys.android.common.activity.AbsActivity
import com.itoys.android.logcat.logcat
import com.itoys.android.network.BaseEntity
import com.itoys.android.network.ResultException
import com.itoys.android.network.networkRequest
...
abstract class AbsViewModel<I : IUIIntent, S : IUIState> : ViewModel(), DefaultLifecycleObserver {
    ...
    /** empty layout state */
    private val _emptyState: Channel<EmptyLayoutUIState> = Channel()
    val emptyState: Flow<EmptyLayoutUIState> = _emptyState.receiveAsFlow()
     ...
     * 发送loading
     */
    fun sendLoading(loading: LoadingUIState) {
     ...
     * 发送Toast
     */
    fun sendToast(toast: ToastUIState) {
