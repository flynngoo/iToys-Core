package com.itoys.android.image.uikit
...
class CircleProgressView @JvmOverloads constructor(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        val maxBarPaintWidth = mReachBarSize.coerceAtLeast(mNormalBarSize)
        val maxPaintWidth = maxBarPaintWidth.coerceAtLeast(mOuterSize)
        var height = 0
        var width = 0
        when (mProgressStyle) {
            ProgressStyle.FILL_IN -> {
